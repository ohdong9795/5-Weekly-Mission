...
import kakaoIcon from '../../images/icons/kakaoIcon.png';
...
export default function ShareModal({ title, width, height, padding, setter, subtitle, shareKakao, shareFacebook }) {
  const handleCopy = () => {
